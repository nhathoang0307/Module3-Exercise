                ...
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            ...
                            <a class="btn btn-outline-dark btn-square"><button style="margin-left: -10px;border: none;background: none;" name="id" value="${product.getId()}"><i class="fa fa-shopping-cart"></i></button></a>
                    ...
                    <div class="text-center py-4">
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5>$${product.getPrice()}</h5><h6 class="text-muted ml-2"><del>$1000.00</del></h6>
                        </div>
