...
public class CustomerServiceJDBC extends DatabaseContext implements ICustomerService {
    ...
    private static final String INSERT_CUSTOMER = "INSERT INTO `customer` (`id`,`name`, `address`, `idCountry`,`picture`) VALUES (?, ?, ?, ?, ?);";
    ...
    private static final String FIND_BY_IDMAX = "SELECT max(id) as max FROM customer";
    ...
    private Customer getCustomerFromResulset(ResultSet rs) throws SQLException {
        ...
        Customer customer = new Customer(id, name, address, idCountry, picture);
        return customer;
    }
    ...
    public void addCustomer(Customer customer) {
        try {
            ...
            preparedStatement.setLong(4, customer.getIdCountry());
            preparedStatement.setString(5, customer.getPicture());
