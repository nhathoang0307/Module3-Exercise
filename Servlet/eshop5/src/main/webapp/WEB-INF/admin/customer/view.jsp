...
<div id="wrapper">
    ...
    <div id="content">
        <div id="main">
            <div>
                <div>
                    <div class="card-header" style="text-align: center;"><h1>Danh sách Khách Hàng</h1></div>
                        ...
                        <table class="table">
                            ...
                            <c:forEach items="${requestScope.customerList}" var="customer">
                                <tr class="odd gradeX">
                                    ...
                                    <td class="text-start">${customer.getFullName()}</td>
                                    <td class="text-end">
                                            ${customer.getEmail()}
                                    </td>
                                    ...
                                    <td>
                                        <a href="/manager-customer?action=edit&id=${customer.getId()}"><i
                                                class="fa fa-edit" style="font-size:24px"></i> </a>
                                        <a href="/manager-customer?action=remove&id=${customer.getId()}"><i
                                                class="fa fa-remove" style="font-size:24px; color: red;"></i> </a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
