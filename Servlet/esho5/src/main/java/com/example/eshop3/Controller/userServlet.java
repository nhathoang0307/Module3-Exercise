...
//                changePassword(request, response);
    ...
    private void editInfoAdmin(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher requestDispatcher;
        requestDispatcher = request.getRequestDispatcher("/WEB-INF/admin/info/edit.jsp");
        requestDispatcher.forward(request, response);
...
//        HttpSession httpSession = request.getSession();
//        httpSession.setAttribute("user", user);
//        requestDispatcher = request.getRequestDispatcher("/WEB-INF/admin/customer/view.jsp");
//        requestDispatcher.forward(request, response);
    }
    ...
    private void editInfoUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        httpSession.setAttribute("user", user);
        RequestDispatcher requestDispatcher;
        requestDispatcher = request.getRequestDispatcher("/WEB-INF/customer/edit.jsp");
        requestDispatcher.forward(request, response);
...
//        requestDispatcher.forward(request, response);
    ...
    private void createUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        updateListUser();
        requestDispatcher = request.getRequestDispatcher("/WEB-INF/admin/user/create.jsp");
        requestDispatcher.forward(request, response);
    }
