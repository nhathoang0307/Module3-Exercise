...
<div id="wrapper">
    ...
    <div id="content">
        <div id="main">
            <div>
                <div>
                    <div class="card-header">Danh sách sản phẩm đặt hàng</div>
                    ...
                    <div class="table-responsive">
                            ...
                            <c:forEach items="${requestScope.orderItems}" var="orderItem">
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        ...
                                        <a href="#"><i class="fa fa-remove" style="font-size:24px; color: red;"></i>
                                        </a>
                                    </td>
                                </tr>
                            </c:forEach>
                        ...
                        <div>
                            <c:if test="${requestScope.order.getStatusId() == 1}">
                                <a href="/manager-oder"><button style="margin-top: 10px">Quay lại</button></a>
                            </c:if>
                            <c:if test="${requestScope.order.getStatusId() == 3}">
                                <a href="/manager-oder?action=listorderTransport"><button style="margin-top: 10px">Quay lại</button></a>
                            </c:if>
                            <c:if test="${requestScope.order.getStatusId() == 4}">
                                <a href="/manager-oder?action=listorderDone"><button style="margin-top: 10px">Quay lại</button></a>
                            </c:if>
                        </div>
